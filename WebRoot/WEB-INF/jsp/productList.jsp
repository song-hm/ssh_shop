...
<div class="container productList">
    ...
    <div class="pagination">
        ...
        <s:if test="csid != null">
            ...
            <s:iterator var="j" begin="1" end="pageBean.totalPage">
                <s:if test="pageBean.page != #j">
                    <a href="${ pageContext.request.contextPath }/product_findByCsid.action?csid=<s:property value="csid"/>&page=<s:property value="#j"/>"><s:property value="#j"/></a>
                </s:if>
                <s:else>
                    <span class="currentPage"><s:property value="#j"/></span>
                </s:else>
            </s:iterator>
